...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Credentials', 'model/DocumentActivity', 'model/DocumentMatch', 'model/JwtToken', 'model/MatchType', 'model/ServiceStatus', 'model/Status', 'api/AuthenticationApi', 'api/IGApi', 'api/ServiceCheckApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Credentials'), require('./model/DocumentActivity'), require('./model/DocumentMatch'), require('./model/JwtToken'), require('./model/MatchType'), require('./model/ServiceStatus'), require('./model/Status'), require('./api/AuthenticationApi'), require('./api/IGApi'), require('./api/ServiceCheckApi'));
  }
}(function(ApiClient, Credentials, DocumentActivity, DocumentMatch, JwtToken, MatchType, ServiceStatus, Status, AuthenticationApi, IGApi, ServiceCheckApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The DocumentActivity model constructor.
     * @property {module:model/DocumentActivity}
     */
